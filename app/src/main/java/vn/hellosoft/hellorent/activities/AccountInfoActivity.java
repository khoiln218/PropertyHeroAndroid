...
public class AccountInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void handleUpdateInfo() {
        ...
        MultipartRequest reqUpdate = new MultipartRequest(EndPoints.UPDATE_INFO, null, vn.hellosoft.hellorent.json.Utils.mimeType, infoPathBody(), new Response.Listener<JSONObject>() {
            @Override
    ...
    private byte[] infoPathBody() {
        ...
        try {
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "AccountID", String.valueOf(account.getId()));
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "FullName", vn.hellosoft.hellorent.json.Utils.iso88951_To_utf8(account.getFullName()));
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "Gender", String.valueOf(account.getGender()));
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "BirthDate", vn.hellosoft.helper.Utils.dateToString(account.getBirthDate()));
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "PhoneNumber", account.getPhoneNumber());
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "Email", account.getEmail());
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "Address", vn.hellosoft.hellorent.json.Utils.iso88951_To_utf8(account.getAddress()));
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "CountryID", String.valueOf(account.getCountryID()));
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "ProvinceID", String.valueOf(account.getProvinceID()));
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "DistrictID", String.valueOf(account.getDistrictID()));
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "IDCode", account.getIdCode());
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "IssuedDate", vn.hellosoft.helper.Utils.dateToString(account.getIssuedDate()));
            vn.hellosoft.hellorent.json.Utils.buildTextPart(dos, "IssuedPlace", vn.hellosoft.hellorent.json.Utils.iso88951_To_utf8(account.getIssuedPlace()));
