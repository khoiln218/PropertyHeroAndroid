...
public class WarningActivity extends AppCompatActivity {
    ...
    private void sendWarning() {
        progressDialog.show();
        MultipartRequest reqWarning = new MultipartRequest(EndPoints.URL_SEND_WARTNING, null, vn.hellosoft.propertyhero.json.Utils.mimeType, pathBodyWarning(), new Response.Listener<JSONObject>() {
            @Override
    ...
    private byte[] pathBodyWarning() {
        ...
        try {
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "AccountID", String.valueOf(AppController.getInstance().getPrefManager().getUserID()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "ProductID", String.valueOf(productID));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "WarningType", String.valueOf(getWarningType()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "Content", vn.hellosoft.propertyhero.json.Utils.iso88951_To_utf8(inputContent.getText().toString()));
