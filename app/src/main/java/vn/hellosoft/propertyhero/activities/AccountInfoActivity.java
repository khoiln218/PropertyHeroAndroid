...
public class AccountInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void handleUpdateInfo() {
        ...
        MultipartRequest reqUpdate = new MultipartRequest(EndPoints.UPDATE_INFO, null, vn.hellosoft.propertyhero.json.Utils.mimeType, infoPathBody(), new Response.Listener<JSONObject>() {
            @Override
    ...
    private byte[] infoPathBody() {
        ...
        try {
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "AccountID", String.valueOf(account.getId()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "FullName", vn.hellosoft.propertyhero.json.Utils.iso88951_To_utf8(account.getFullName()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "Gender", String.valueOf(account.getGender()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "BirthDate", vn.hellosoft.helper.Utils.dateToString(account.getBirthDate()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "PhoneNumber", account.getPhoneNumber());
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "Email", account.getEmail());
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "Address", vn.hellosoft.propertyhero.json.Utils.iso88951_To_utf8(account.getAddress()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "CountryID", String.valueOf(account.getCountryID()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "ProvinceID", String.valueOf(account.getProvinceID()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "DistrictID", String.valueOf(account.getDistrictID()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "IDCode", account.getIdCode());
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "IssuedDate", vn.hellosoft.helper.Utils.dateToString(account.getIssuedDate()));
            vn.hellosoft.propertyhero.json.Utils.buildTextPart(dos, "IssuedPlace", vn.hellosoft.propertyhero.json.Utils.iso88951_To_utf8(account.getIssuedPlace()));

            dos.writeBytes(vn.hellosoft.propertyhero.json.Utils.twoHyphens + vn.hellosoft.propertyhero.json.Utils.boundary + vn.hellosoft.propertyhero.json.Utils.twoHyphens + vn.hellosoft.propertyhero.json.Utils.lineEnd);
