...
public class AccountRequest {
    ...
    private static byte[] accLoginPathBody(String userName, String pwd, String addr, double lat, double lng) {
        ...
        try {
            ...
            Utils.buildTextPart(dos, "Version", vn.hellosoft.helper.Utils.versionRelease() + "_" + vn.hellosoft.helper.Utils.getVersionName());
    ...
    private static byte[] socialLoginPathBody(Account account, String token, String address, double lat, double lng) {
        ...
        try {
            ...
            Utils.buildTextPart(dos, "BirthDate", account.getBirthDate() != null ? vn.hellosoft.helper.Utils.dateToString(account.getBirthDate()) : "");
